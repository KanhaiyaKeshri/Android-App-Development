...
public class CarpenterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contracters.add(new Contracter("PK Carpenter","8745250000 ,pk_carpenter@gmail",R.drawable.img_13));
        contracters.add(new Contracter("United Carpenter","9745250000 , united_carpenter@gmail",R.drawable.img_15));
        contracters.add(new Contracter("Rakesh group","7845250000 ,rakesh_group@gmail",R.drawable.img_14));
        contracters.add(new Contracter("Dikshit group","6585250000 , dikshit_group@gmail",R.drawable.img_15));
        contracters.add(new Contracter("Raj group of Carpenter","9995250000 , raj_group_carpenter@gmail",R.drawable.img_13));
